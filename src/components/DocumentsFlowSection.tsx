          ...
          <div className="grid lg:grid-cols-[1fr,2fr] gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-base md:text-lg text-muted-foreground font-light">
                Вы выбираете папки и файлы, в которых Flumen будет работать. ИИ-агент сам ищет нужную информацию в массиве данных и создаёт документы DOCX, DOC и таблицы XLSX, XLS в нужных папках
              </p>
            </div>
